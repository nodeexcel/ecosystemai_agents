"""Attachment content upload file_id signature type changed

Revision ID: 018108affe13
Revises: 6b091414c918
Create Date: 2025-10-30 10:21:33.253135
...
revision: str = '018108affe13'
down_revision: Union[str, None] = '6b091414c918'
...
def upgrade() -> None:
    ...
    op.alter_column('content_create_attachment', 'file_id',
