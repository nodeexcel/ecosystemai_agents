...
Revision ID: 3b78993a1227
Revises: f50f87858afe
Create Date: 2025-07-07 13:34:38.674159
...
revision: str = '3b78993a1227'
down_revision: Union[str, None] = 'f50f87858afe'
...
def upgrade() -> None:
    ...
    op.alter_column('account_chat_history', 'name',
