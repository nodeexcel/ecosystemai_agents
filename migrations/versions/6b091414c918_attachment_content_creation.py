"""Attachment content creation

Revision ID: 6b091414c918
Revises: 9b9d0da6c982
Create Date: 2025-10-30 10:17:27.094936
...
def upgrade() -> None:
    ...
    op.drop_index('ix_agent_integration_track_id', table_name='agent_integration_track')
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('customer_support_chats', sa.Column('third_party_lead_id', sa.VARCHAR(), autoincrement=False, nullable=True))
    op.add_column('customer_support_chats', sa.Column('connected_platform_id', sa.VARCHAR(), autoincrement=False, nullable=True))
    op.add_column('customer_support_chats', sa.Column('platform', sa.VARCHAR(), autoincrement=False, nullable=True))
    ...
    sa.Column('integration_platform', sa.VARCHAR(), autoincrement=False, nullable=False),
    ...
    sa.PrimaryKeyConstraint('id', name='agent_integration_track_pkey')
    )
    op.create_index('ix_agent_integration_track_id', 'agent_integration_track', ['id'], unique=False)
