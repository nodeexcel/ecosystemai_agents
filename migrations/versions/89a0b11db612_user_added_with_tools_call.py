"""user added with tools call

Revision ID: 89a0b11db612
Revises: 9ddc5e3f5927
Create Date: 2025-10-30 14:36:29.475564
...
revision: str = '89a0b11db612'
down_revision: Union[str, None] = '9ddc5e3f5927'
...
def upgrade() -> None:
    ...
    op.add_column('knowledge_attachment', sa.Column('user_id', sa.Integer(), nullable=True))
    op.create_foreign_key(None, 'knowledge_attachment', 'users', ['user_id'], ['id'], ondelete='CASCADE')
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint(None, 'knowledge_attachment', type_='foreignkey')
    op.drop_column('knowledge_attachment', 'user_id')
